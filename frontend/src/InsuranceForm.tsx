  ...
  return (
    <PageLayout>
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        {showAdditional && (
          <FormField label="Additional coverage details" name="additionalCoverage" value={data.additionalCoverage} onChange={handleChange} error={errors.additionalCoverage} />
        )}
